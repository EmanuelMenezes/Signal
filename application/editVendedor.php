...
$idVendedor = $_GET['id'];
$get_datas = $conn->prepare("SELECT * FROM vendedor WHERE id_vendedor = $idVendedor");
$get_datas->execute();
...
<html>
    ...
    <form method="POST" action="updateVendedor.php?id=<?=$idVendedor?>" class="row g-3">
        <div class="col-md-6">
            <label for="inputNome" class="form-label">Nome</label>
            <input type="text" class="form-control" name="inputNome" value="<?=$res['nome_vendedor']?>" required>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-10">
            ...
            <input type="text" class="form-control" name="inputContato" value="<?=$res['contato']?>" required>
        </div>
        <div class="col-12">
        </div>
